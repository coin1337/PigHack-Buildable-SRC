...
public class Feature
    ...
    public TextManager renderer = PigHack.textManager;
    private String name;
    ...
    public Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof PigHackGui) {
            PigHackGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }
