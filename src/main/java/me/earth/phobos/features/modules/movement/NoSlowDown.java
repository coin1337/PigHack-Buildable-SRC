...
public class NoSlowDown
    ...
    public void onUpdate() {
        ...
        if (this.webs.getValue().booleanValue() && PigHack.moduleManager.getModuleByClass(Flight.class).isDisabled() && PigHack.moduleManager.getModuleByClass(Phase.class).isDisabled() && NoSlowDown.mc.player.isInWeb) {
