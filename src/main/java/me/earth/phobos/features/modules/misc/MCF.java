...
public class MCF
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (this.keyboard.getValue().booleanValue() && Keyboard.getEventKeyState() && !(MCF.mc.currentScreen instanceof PigHackGui) && this.key.getValue().getKey() == Keyboard.getEventKey()) {
            this.onClick();
        }
    }
    ...
    private void onClick() {
        ...
        if (result != null && result.typeOfHit == RayTraceResult.Type.ENTITY && (entity = result.entityHit) instanceof EntityPlayer) {
            if (PigHack.friendManager.isFriend(entity.getName())) {
                PigHack.friendManager.removeFriend(entity.getName());
                ...
                PigHack.friendManager.addFriend(entity.getName());
