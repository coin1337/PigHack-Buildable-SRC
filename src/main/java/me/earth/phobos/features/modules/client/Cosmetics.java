...
public class Cosmetics
    ...
    public void onRenderPlayer(RenderPlayerEvent.Post event) {
        if (!PigHack.cosmeticsManager.hasCosmetics(event.getEntityPlayer()) || EntityUtil.isFakePlayer(event.getEntityPlayer())) {
            return;
        }
        for (ModelBase model : PigHack.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
