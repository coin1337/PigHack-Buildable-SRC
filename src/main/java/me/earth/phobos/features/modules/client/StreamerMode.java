...
public class StreamerMode
    ...
    public void onUpdate() {
        if (this.window != null) {
            ...
            drawInfo.add("TPS: " + PigHack.serverManager.getTPS());
            drawInfo.add("Ping: " + PigHack.serverManager.getPing() + "ms");
            drawInfo.add("Speed: " + PigHack.speedManager.getSpeedKpH() + "km/h");
            ...
            String text = PigHack.rotationManager.getDirection4D(false);
            drawInfo.add("");
            drawInfo.add(text);
            ...
            for (PotionEffect effect : PigHack.potionManager.getOwnPotions()) {
                String potionText = TextUtil.stripColor(PigHack.potionManager.getColoredPotionString(effect));
