...
public abstract class Command
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(PigHack.commandManager.getClientMessage() + " >> " + "\u00a7r" + message);
        if (notification) {
            PigHack.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return PigHack.commandManager.getPrefix();
    }
