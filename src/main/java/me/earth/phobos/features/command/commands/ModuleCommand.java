...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : PigHack.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module : PigHack.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = PigHack.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = PigHack.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
