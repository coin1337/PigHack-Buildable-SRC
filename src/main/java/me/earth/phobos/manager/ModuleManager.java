...
import me.earth.phobos.features.modules.pvptools.*;
...
public class ModuleManager
    ...
    public void init() {
        ...
        //pvp tools
        this.modules.add(new AutoArmorOld());
        this.modules.add(new AutoTrapOld());
        this.modules.add(new HoleFillerOld());
        this.modules.add(new OffhandOld());
        this.modules.add(new SurroundOld());
        this.modules.add(new TrollModule());
        this.modules.add(new BurrowDetect());
        ...
        moduleColorMap.put(this.getModuleByClass(YPort.class), new Color(255, 251, 0, 155));
        ...
        this.moduleColorMap.put(this.getModuleByClass(ReverseStep.class), new Color(68, 178, 142));
    ...
    public void onKeyPressed(int eventKey) {
        if (eventKey == 0 || !Keyboard.getEventKeyState() || ModuleManager.mc.currentScreen instanceof PigHackGui) {
            return;
        }
        this.modules.forEach(module -> {
